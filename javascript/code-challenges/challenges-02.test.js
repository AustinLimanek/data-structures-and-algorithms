...
const addOne = (arr) => {
  let solution = arr.map(element => element + 1);
  return solution;
};
...
const addQuestion = (arr) => {
  let solution = arr.map(element => element + '?');
  return solution;
};
...
const forLoopTwoToThe = (arr) => {
  let solution = [];
  for (let x in arr){
    solution.push(Math.pow(2, arr[x]));
  }
  return solution;
};
...
const forEachTwoToThe = (arr) => {
  let solution = [];
  arr.forEach(element => {
    solution.push(Math.pow(2, element));
  });
  return solution;
};
...
const mapTwoToThe = (arr) => {
  let solution = arr.map(element => Math.pow(2, element));
  return solution;
};
